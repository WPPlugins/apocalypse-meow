...
class cli extends \WP_CLI_Command {
	...
	public function version() {
		...
		$translated = array(
			...
			'Company'=>__('Company', 'apocalypse-meow'),
			'Copyright'=>__('Copyright', 'apocalypse-meow'),
			'developer'=>__('Developer', 'apocalypse-meow'),
			'Domains'=>__('Domains', 'apocalypse-meow'),
			...
			'License'=>__('License', 'apocalypse-meow'),
			...
			'Premium'=>__('Premium', 'apocalypse-meow'),
			'Purchased'=>__('Purchased', 'apocalypse-meow'),
			'single'=>__('Single', 'apocalypse-meow'),
