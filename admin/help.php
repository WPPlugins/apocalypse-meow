...
?>
<div class="wrap" id="vue-help" data-env="<?php echo esc_attr(json_encode($data, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT)); ?>" v-cloak>
	<h1>Apocalypse Meow: <?php echo esc_html__('Help', 'apocalypse-meow'); ?></h1>
	...
	<div id="poststuff">
		<div id="post-body" class="metabox-holder meow-columns one-two fixed">
			...
			<div class="postbox-container one">
				...
				=============================================== -->
				<div class="postbox">
					<h3 class="hndle"><?php echo esc_html__('Quick Links', 'apocalypse-meow'); ?></h3>
					<div class="inside">
